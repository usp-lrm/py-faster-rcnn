...
#    caffemodel = os.path.join(cfg.DATA_DIR, 'faster_rcnn_models', NETS[args.demo_net][1])
    ...
    prototxt = 'models/kitti/VGG16/faster_rcnn_end2end/test.prototxt'
    caffemodel = 'output/faster_rcnn_end2end/kitti_train/vgg16_faster_rcnn_iter_88000.caffemodel'
